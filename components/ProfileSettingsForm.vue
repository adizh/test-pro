        ...
        <div class="header">
            ...
            <div class="header-info">
                ...
                <div class="header-info-text">
                    <p>{{form.fullName?.value|| 'Alexa Rawles'  }}
                    </p>
            ...
            <div class="header-btn">
                ...
                <button class='blue-btn'  @click="saveForm">Save</button>
            </div>
        </div>
...
<div v-for="field in formFieldsArray" :key="field?.placeholder" class="my-6">
    <div  class="form-field flex flex-col gap-3" v-if='field?.type!== "select"' >
        ...
        <input
            ...
            class="form-input focus:border-sky-500"
            @input="validateField(field.key)"
        />
        <span v-if="field.error" class='text-red-500 text-sm'>{{ field.error }}</span>


    </div>


    <UISelect  :error="form[field.key as keyof typeof form].error"  v-else-if='field?.type==="select"' :values="form[field.key as keyof typeof form].values as any" @selectItem="selectItem"/>
